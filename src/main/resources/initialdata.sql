CREATE TABLE IF NOT EXISTS s4032_csbot.users (user_id INT AUTO_INCREMENT, username VARCHAR(50) NOT NULL UNIQUE, steamID VARCHAR(250) UNIQUE, faceitID VARCHAR(250) UNIQUE, discordID VARCHAR(250) UNIQUE, PRIMARY KEY (user_id));
...
CREATE TABLE IF NOT EXISTS s4032_csbot.gregflix(title VARCHAR(200), imdbid VARCHAR(20));
